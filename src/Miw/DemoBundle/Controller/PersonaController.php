...
use Miw\DemoBundle\Entity\Persona;
use Miw\DemoBundle\Form\PersonaType;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MiwDemoBundle:Persona')->findAll();

        return $this->render('MiwDemoBundle:Persona:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MiwDemoBundle:Persona:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MiwDemoBundle:Persona')->find($id);
        ...
        return $this->render('MiwDemoBundle:Persona:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MiwDemoBundle:Persona:edit.html.twig', array(
            'entity'      => $entity,
